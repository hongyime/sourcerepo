...
- 2026-09-15: Follow each repository's contribution rules; config sync seeds missing rule files and preserves existing overrides. Use conventional sync branches and titles.
